...
A few of our dependencies are optional since they are not required for the Core NLU functions. If you are interested in developing for Cisco Webex Team, you can install the bot dependency by typing:

.. code-block:: shell

  pip install mindmeld[bot]

If you are interested in using the LSTM entity recognizer, you will need to install Tensorflow:
