...
MALLARD_JAR_PATH = os.path.join(os.path.join(RESOURCES_FOLDER, 'duckling-clojure'), 'mindmeld-mallard.jar')
MALLARD_UBUNTU_PATH = os.path.join(os.path.join(RESOURCES_FOLDER, 'x86_64-linux'), 'duckling-example-exe')
MALLARD_OSX_PATH = os.path.join(os.path.join(RESOURCES_FOLDER, 'x86_64-osx'), 'duckling-example-exe')
