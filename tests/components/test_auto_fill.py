...
@pytest.mark.conversation
def test_auto_fill_happy_path_validation(kwik_e_mart_app, kwik_e_mart_app_path, qa_kwik_e_mart):
    ...
    directives = convo.process("the store on elm street").directives
    assert_target_dialogue_state(convo, None)
