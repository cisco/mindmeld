...
def test_custom_data(kwik_e_mart_nlp):
    ...
    if hasattr(store_hours_ent_rec, "_model_config") and store_hours_ent_rec._model_config:
    ...
    if hasattr(exit_ent_rec, "_model_config") and exit_ent_rec._model_config:
